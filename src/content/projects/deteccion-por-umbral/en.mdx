...
tagline: It contains mass encryption without having seen the binary and with nobody in the loop. Three system signals form a score, and only that score decides.
