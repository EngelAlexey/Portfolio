...
The platform brings together the public site and the staff portal: client due diligence, accounts receivable, payroll, and tracking of the requests that arrive through the site. It is under active development and grows module by module. I joined to build on it and to define its security model.

## Problem

The site ran on a third-party service the team did not administer. The client was asking for a portal for their staff holding critical information, and that piece needed guarantees only owned infrastructure can hold.
