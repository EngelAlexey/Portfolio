...
tagline: Sitio público y portal autenticado desde la misma imagen, desplegados como dos servicios con permisos distintos.
...
El sitio corría sobre WordPress, y eso ponía techo a lo que se podía construir encima. El cliente pedía un portal de usuario con información crítica, y esa pieza no podía descansar en una plataforma que no controlábamos.
...
El modelo lee documentos y propone. Las decisiones las toma el código.
...
A cambio no depende de que la aplicación se comporte correctamente. Si el sitio público llegara a ejecutar código arbitrario, seguiría sin tener credenciales de base de datos que usar.
