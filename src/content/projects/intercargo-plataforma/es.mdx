...
La plataforma reúne el sitio público y el portal del personal: debida diligencia de clientes, cuentas por cobrar, nómina y el seguimiento de las solicitudes que entran por el sitio. Está en desarrollo activo y crece por módulos. Entré a construir sobre ella y a definir su modelo de seguridad.

## Problema

El sitio corría sobre un servicio de terceros que el equipo no administraba. El cliente pedía un portal para su personal con información crítica, y esa pieza necesitaba garantías que solo se sostienen sobre infraestructura propia.
