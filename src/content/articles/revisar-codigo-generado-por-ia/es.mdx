...
cover: null
instagram: https://www.instagram.com/reel/DdIUA1MsPlm/
---
...
El nombre inventado es predecible, y quien lo registra en el registro público consigue que se instale código suyo en cualquier proyecto que siga la sugerencia. Si el gestor ejecuta los scripts de instalación, el daño no espera a que alguien importe el paquete. Cuáles lo hacen depende de la versión: yarn 1 los ejecuta sin excepciones, npm los ejecutó hasta la 11, y npm 12 y pnpm 10 los bloquean salvo los que estén en una lista declarada aparte. [Otro artículo mide los cuatro comportamientos](/es/blog/npm-vs-pnpm-seguridad).
